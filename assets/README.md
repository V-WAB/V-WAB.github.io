...
| `story.jpg` or `story.mp4` | `STORY_IMAGE` / `STORY_VIDEO` | Brand story section, beside the founder's note. The video wins if both exist, and a `story.jpg` alongside it becomes the poster frame. |
